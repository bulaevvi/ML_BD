...
Теги в строке разделяются `; ` - точкой запятой с пробелом, поэтому используется SPLIT по этой комюинации символов.
...
Результаты выполнения команд приведены в файле **Block_2_results.pdf**
